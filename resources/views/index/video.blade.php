...
<body>
   <div class="linevideo" style="overflow-x:hidden">
        ...
        <div style="width:100%;margin-top:20px;">
			<video width="auto" id="example_video_1" class="video-js vjs-default-skin  vjs-big-play-centered vvi " controls preload="none"  poster="/static/images/c8.jpg" data-setup="{}"><!--poster是视频未播放前的展示图片-->
