...
<div class="head" id="fixed">
    <div class="nav">
        ...
        <span class="massage">
            ...
            <a href="/index/login" class="link2 he">登录</a>
            <a href="/index/register" class="link2 he">注册</a>
            <a href="/index/mycourse" style="width:70px" class="link2 he ico" target="_blank">个人中心</a>
        </span>
    </div>
</div>
    ...
    <div class="courseright">
      ...
      <ul class="courseulr">
        <li>
            ...
            <a href="/index/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c1.jpg" title="会计基础"></a>
        ...
        <li>
            <div class="courselist">
            <a href="/index/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c2.jpg" title="会计基础"></a>
        ...
        <li>
            <div class="courselist">
            <a href="/index/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c3.jpg" title="会计基础"></a>
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c4.jpg" >
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c5.jpg" >
            <p class="courTit">HTTP下载课程</p>
            <div class="gray">
            <span>5课时 60分钟</span>
            <span class="sp1">1255555人学习</span>
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c6.jpg" >
            <p class="courTit">HTTP下载课程</p>
            <div class="gray">
            <span>5课时 60分钟</span>
            <span class="sp1">1255555人学习</span>
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c7.jpg" >
            <p class="courTit">HTTP下载课程</p>
            <div class="gray">
            <span>5课时 60分钟</span>
            <span class="sp1">1255555人学习</span>
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c8.jpg" >
            <p class="courTit">HTTP下载课程</p>
            <div class="gray">
            <span>5课时 60分钟</span>
            <span class="sp1">1255555人学习</span>
       ...
       <li>
            <div class="courselist">
            <img style="border-radius:3px 3px 0 0;" width="240" src="/static/images/c9.jpg" >
            <p class="courTit">HTTP下载课程</p>
            <div class="gray">
            <span>5课时 60分钟</span>
            <span class="sp1">1255555人学习</span>
